sap.ui.jsview("views.Agent.UpdateAgent", {

	/** Specifies the Controller belonging to this View. 
	* In the case that it is not implemented, or that "null" is returned, this View does not have a Controller.
	* @memberOf views.Agent.UpdateAgent
	*/ 
	getControllerName : function() {
		return "views.Agent.UpdateAgent";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		var oFields = [{ label1: "Title",field1: "{/tranDetail/basicInfoToOldbasicInfo/0/TitleText}",field1a: "{/tranDetail/TitleText}",label2: "Middle Name",field2: "{/tranDetail/basicInfoToOldbasicInfo/0/Middlename}",fld2align: "" ,field2a: "{/tranDetail/Middlename}"}
		    		 ,{ label1: "First Name",field1: "{/tranDetail/basicInfoToOldbasicInfo/0/Firstname}",field1a: "{/tranDetail/Firstname}",label2: "Suffix",field2: "{/tranDetail/basicInfoToOldbasicInfo/0/SuffixText}",fld2align: "" ,field2a: "{/tranDetail/SuffixText}"}
		    		 ...
		    		 ,{ label1: "Citizenship",field1: "{/tranDetail/basicInfoToOldbasicInfo/0/CitizenshipText}",field1a: "{/tranDetail/CitizenshipText}",label2: "Birth Date",field2: "{/tranDetail/basicInfoToOldbasicInfo/0/Birthdate}",fld2align: "" ,field2a: "{/tranDetail/Birthdate}"}
					 ...
					 ,{ label1: "REBL Expiration Date",field1: "{/tranDetail/basicInfoToOldbasicInfo2/0/ReblExpdate}",field1a: "{/tranDetail/basicInfoTobasicInfo2/0/ReblExpdate}"}];
					 //Add Christian de Leon 12/11/2018
		...
		oFields = [{ label1: "Contract Start Date",field1: "{/tranDetail/basicInfoToOldContract1/0/Contractstart}",field1a: "{/tranDetail/basicInfoToContract1/0/Contractstart}",label2: "Contract End Date",field2: "{/tranDetail/basicInfoToOldContract1/0/Contractend}",field2a: "{/tranDetail/basicInfoToContract1/0/Contractend}",fld2align: ""}
				 ...
				 //Add Christian de Leon 08/14/2018 additional field
				 ,{ label1: "Witholding Tax Code",field1: "{/tranDetail/basicInfoToOldContract1/0/TaxCode}",field1a: "{/tranDetail/basicInfoToContract1/0/TaxCode}",label2: "Input Tax Code",field2: "{/tranDetail/basicInfoToOldContract1/0/InputTaxCode}",field2a: "{/tranDetail/basicInfoToContract1/0/InputTaxCode}",fld2align: ""}
				 //End Add Christian de Leon
				 ,{ label1: "iText Group",field1: "{/tranDetail/basicInfoToOldContract1/0/ItextGroupText}",field1a: "{/tranDetail/basicInfoToContract1/0/ItextGroupText}"}
		 ];
       ...
       // oAccordion.addSection( oSection5 );
		...
		var oBtnApprove = new sap.ui.commons.Button(sessionCache["pageID"] + "oBtnApprove",{
			tooltip : "Approve change of Agent Information",
			width : "100px",
			height : "30px",
			text : "Approve",
			press : function() {
				sap.ui.commons.MessageBox.show(
					      "Are you sure you want to approve request to change Agent information?",
		...
		var oBtnDisapprove = new sap.ui.commons.Button(sessionCache["pageID"] + "oBtnDisapprove",{
			tooltip : "Disapprove change of Agent Information",
			width : "100px",
			height : "30px",
			text : "Disapprove",
			press : function() {
				sap.ui.commons.MessageBox.show(
					      "Are you sure you want to disapprove request to change Agent Information?",
					      sap.ui.commons.MessageBox.Icon.INFORMATION,
					      "Disapprove Request",
					      [sap.ui.commons.MessageBox.Action.YES, sap.ui.commons.MessageBox.Action.NO],
					      function(bResult) { 
