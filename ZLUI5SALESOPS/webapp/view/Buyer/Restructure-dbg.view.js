sap.ui.jsview("views.Buyer.Restructure", {

	/** Specifies the Controller belonging to this View. 
	* In the case that it is not implemented, or that "null" is returned, this View does not have a Controller.
	* @memberOf views.Buyer.Restructure
	*/ 
	getControllerName : function() {
		return "views.Buyer.Restructure";
	},
...
var oCell;
        ...
        oFields = [{row1: [{type:"Label",value:"AA Number ",align: ""}
			  ,{type:"Text",value:"{/tranDetail/C06HeaderSet/0/Refnumber}",align: ""}
			  ,{type:"",value:"",align: ""}
			  ,{type:"Label",value:"Date Submitted ",align: ""}
			  ,{type:"Text",value:"{/tranDetail/C06HeaderSet/0/Date}",align: ""}
			]}
				,{row1: [{type:"Label",value:"Client Name ",align: ""}
				,{type:"Text",value:"{/tranDetail/C06HeaderSet/0/Name}",align: ""}
				,{type:"",value:"",align: ""}
				,{type:"Label",value:"JG Summit Employee ",align: ""}
				,{type:"Text",value:"{/tranDetail/C06HeaderSet/0/Employee}",align: ""}
			]}
		];
...
//        	template: new sap.ui.commons.TextView().bindProperty("text" , "ProjectText"),/*{
		...
		tblBasic.bindRows("/tranDetail/C14ContractDetaSet"); 
		

        oFields = [{row1: [{type:"Label",value:"NPV Rate",align: ""}
				  ,{type:"Text",value:"{/tranDetail/C03SchemeSet/0/Npv}",align: "End"}
				  ,{type:"",value:"",align: ""}
				  ,{type:"",value:"",align: ""}
				  ,{type:"",value:"",align: ""}
				  ,{type:"",value:"",align: ""}
        	 	...
        	 	,{row1: [{type:"Label",value:"Gross TCP",align: ""}
			  		,{type:"Text",value:"{/tranDetail/C15CurrentPriceSet/0/GrossTcp}",align: "End"}
			  		,{type:"",value:"",align: ""}
			  		,{type:"Text",value:"{/tranDetail/C07ProposedScheSet/0/GrossTcp}",align: "End"}
			  		,{type:"",value:"",align: ""}
			  		,{type:"Text",value:"{/tranDetail/C08AdjustmentScSet/0/GrossTcp}",align: "End"}
			]}
				,{row1: [{type:"Label",value:"Less: Discount/Rebate",align: ""}
				  ,{type:"Text",value:"{/tranDetail/C15CurrentPriceSet/0/Discount}",align: "End"}
				  ,{type:"",value:"",align: ""}
				  ,{type:"Text",value:"{/tranDetail/C07ProposedScheSet/0/Discount}",align: "End"}
				  ,{type:"",value:"",align: ""}
				  ,{type:"Text",value:"{/tranDetail/C08AdjustmentScSet/0/Discount}",align: "End"}
			]}
				,{row1: [{type:"Label",value:"Fall in Between Adjustment",align: ""}
				  ,{type:"Text",value:"{/tranDetail/C15CurrentPriceSet/0/FibAdj}",align: "End"}
				  ,{type:"",value:"",align: ""}
				  ,{type:"Text",value:"{/tranDetail/C07ProposedScheSet/0/FibAdj}",align: "End"}
				  ,{type:"",value:"",align: ""}
				  ,{type:"Text",value:"{/tranDetail/C08AdjustmentScSet/0/FibAdj}",align: "End"}
			]}
				,{row1: [{type:"Label",value:"Net TCP",align: ""}
				  ,{type:"Text",value:"{/tranDetail/C15CurrentPriceSet/0/NetTcp}",align: "End"}
				  ,{type:"",value:"",align: ""}
				  ,{type:"Text",value:"{/tranDetail/C07ProposedScheSet/0/NetTcp}",align: "End"}
				  ,{type:"",value:"",align: ""}
				  ,{type:"Text",value:"{/tranDetail/C08AdjustmentScSet/0/NetTcp}",align: "End"}
			]}
				,{row1: [{type:"Label",value:"Total TCP Payments",align: ""}
				  ,{type:"Text",value:"{/tranDetail/C15CurrentPriceSet/0/TotalTcp}",align: "End"}
				  ,{type:"",value:"",align: ""}
				  ,{type:"",value:"",align: ""}
				  ,{type:"",value:"",align: ""}
				  ,{type:"",value:"",align: ""}
				...
				,{row1: [{type:"Label",value:"Amount to be Forfeited",align: ""}
				  ,{type:"Text",value:"{/tranDetail/C15CurrentPriceSet/0/Forfeited}",align: "End"}
				  ,{type:"",value:"",align: ""}
				  ,{type:"",value:"",align: ""}
				  ,{type:"",value:"",align: ""}
				  ,{type:"",value:"",align: ""}
				...
				,{row1: [{type:"Label",value:"Amount to be Applied as Payment",align: ""}
				  ,{type:"Text",value:"{/tranDetail/C15CurrentPriceSet/0/AppliedPay}",align: "End"}
				  ,{type:"",value:"",align: ""}
				  ,{type:"",value:"",align: ""}
				  ,{type:"",value:"",align: ""}
				  ,{type:"",value:"",align: ""}
				...
				,{row1: [{type:"Label",value:"Net Amount for Restructuring",align: ""}
				  ,{type:"Text",value:"{/tranDetail/C15CurrentPriceSet/0/NetRestruc}",align: "End"}
				  ,{type:"",value:"",align: ""}
				  ,{type:"",value:"",align: ""}
				  ,{type:"",value:"",align: ""}
				  ,{type:"",value:"",align: ""}
				...
				,{row1: [{type:"Label",value:"Payment Scheme",align: ""}
				  ,{type:"Text",value:"{/tranDetail/C15CurrentPriceSet/0/ZzPaymnt1}",align: "End"}
				  ,{type:"",value:"",align: ""}
				  ,{type:"Text",value:"{/tranDetail/C07ProposedScheSet/0/ZzPaymnt1}",align: "End"}
				  ,{type:"",value:"",align: ""}
				  ,{type:"",value:"",align: ""}
			]}
				,{row1: [{type:"Label",value:"Turn-over Taxes, Fees & Expenses (TTFE)",align: ""}
				  ,{type:"Text",value:"{/tranDetail/C15CurrentPriceSet/0/Ttfe}",align: "End"}
				  ,{type:"",value:"",align: ""}
				  ,{type:"Text",value:"{/tranDetail/C07ProposedScheSet/0/Ttfe}",align: "End"}
				  ,{type:"",value:"",align: ""}
				  ,{type:"Text",value:"{/tranDetail/C08AdjustmentScSet/0/Ttfe}",align: "End"}
			]}
		];
		...
		var oFields = [{row1: [{type:"Label",value:"Payment Scheme Type",align: ""}
		  					  ,{type:"Text",value:"{/tranDetail/C21SummaryOldSet/0/Xmbez}",align: ""}
							  ,{type:"",value:"",align: ""}
		  					  ,{type:"Text",value:"{/tranDetail/C24SummaryNewSet/0/Xmbez}",align: ""}
					  ]}
					 ,{row1: [{type:"Label",value:"Scheme Overview",align: ""}
					  		 ,{type:"Text",value:"{/tranDetail/C21SummaryOldSet/0/Overview}",align: ""}
							  ,{type:"",value:"",align: ""}
		  					  ,{type:"Text",value:"{/tranDetail/C24SummaryNewSet/0/Overview}",align: ""}
					  ]}
					 ,{row1: [{type:"Label",value:"RF Deduction",align: ""}
					 		 ,{type:"Text",value:"{/tranDetail/C21SummaryOldSet/0/ZzPaymnt3Desc}",align: ""}
							  ,{type:"",value:"",align: ""}
		  					  ,{type:"Text",value:"{/tranDetail/C24SummaryNewSet/0/ZzPaymnt3Desc}",align: ""}
					  ]}
					 ,{row1: [{type:"Label",value:"Payment Type",align: ""}
			 		 		,{type:"Text",value:"{/tranDetail/C21SummaryOldSet/0/ZzPaytype}",align: ""}
							  ,{type:"",value:"",align: ""}
		  					  ,{type:"Text",value:"{/tranDetail/C24SummaryNewSet/0/ZzPaytype}",align: ""}
			 		  ]}
					 ,{row1: [{type:"Label",value:"Reservation Date",align: ""}
		 		 			 ,{type:"Text",value:"{/tranDetail/C21SummaryOldSet/0/ReserveDate}",align: ""}
							  ,{type:"",value:"",align: ""}
		  					  ,{type:"Text",value:"{/tranDetail/C24SummaryNewSet/0/ReserveDate}",align: ""}
		 		 	  ]}
					 ,{row1: [{type:"Label",value:"Reservation Fee",align: ""}
		 		 			 ,{type:"Text",value:"{/tranDetail/C21SummaryOldSet/0/ReserveFee}",align: ""}
							  ,{type:"",value:"",align: ""}
		  					  ,{type:"Text",value:"{/tranDetail/C24SummaryNewSet/0/ReserveFee}",align: ""}
		 		 	  ]}
					 ,{row1: []}
					 ,{row1: [{type:"Label",value:"Total Down Payment",align: ""}
		 		 			 ,{type:"Text",value:"{/tranDetail/C21SummaryOldSet/0/DpAmt}",align: ""}
							  ,{type:"",value:"",align: ""}
		  					  ,{type:"Text",value:"{/tranDetail/C24SummaryNewSet/0/DpAmt}",align: ""}
		 		 	  ]}
					 ,{row1: [{type:"Label",value:"Number of Months/Monthly",align: ""}
		 		 			 ,{type:"Text",value:"{/tranDetail/C21SummaryOldSet/0/DpMos}",align: ""}
							  ,{type:"",value:"",align: ""}
		  					  ,{type:"Text",value:"{/tranDetail/C24SummaryNewSet/0/DpMos}",align: ""}
		 		 	  ]}
					 ,{row1: [{type:"Label",value:"Down Payment Period",align: ""}
		 		 			 ,{type:"Text",value:"{/tranDetail/C21SummaryOldSet/0/DpPeriod}",align: ""}
							  ,{type:"",value:"",align: ""}
		  					  ,{type:"Text",value:"{/tranDetail/C24SummaryNewSet/0/DpPeriod}",align: ""}
		 		 	  ]}
					 ,{row1: []}
					 ,{row1: [{type:"Label",value:"Total Installment",align: ""}
		 		 			 ,{type:"Text",value:"{/tranDetail/C21SummaryOldSet/0/InstPrinAmt}",align: ""}
							  ,{type:"",value:"",align: ""}
		  					  ,{type:"Text",value:"{/tranDetail/C24SummaryNewSet/0/InstPrinAmt}",align: ""}
		 		 	  ]}
					 ,{row1: [{type:"Label",value:"Interest Rate",align: ""}
		 		 			 ,{type:"Text",value:"{/tranDetail/C21SummaryOldSet/0/InstIntRate}",align: ""}
							  ,{type:"",value:"",align: ""}
		  					  ,{type:"Text",value:"{/tranDetail/C24SummaryNewSet/0/InstIntRate}",align: ""}
		 		 	  ]}
					 ,{row1: [{type:"Label",value:"Number of Months/Monthly",align: ""}
		 		 			 ,{type:"Text",value:"{/tranDetail/C21SummaryOldSet/0/InstPrinMos}",align: ""}
							  ,{type:"",value:"",align: ""}
		  					  ,{type:"Text",value:"{/tranDetail/C24SummaryNewSet/0/InstPrinMos}",align: ""}
		 		 	  ]}
					 ,{row1: [{type:"Label",value:"Installment Period",align: ""}
		 		 			 ,{type:"Text",value:"{/tranDetail/C21SummaryOldSet/0/InstPrinPeriod}",align: ""}
							  ,{type:"",value:"",align: ""}
		  					  ,{type:"Text",value:"{/tranDetail/C24SummaryNewSet/0/InstPrinPeriod}",align: ""}
		 		 	  ]}
					 ,{row1: []}
					 ,{row1: [{type:"Label",value:"Total Retention",align: ""}
		 		 			 ,{type:"Text",value:"{/tranDetail/C21SummaryOldSet/0/RetAmt}",align: ""}
							  ,{type:"",value:"",align: ""}
		  					  ,{type:"Text",value:"{/tranDetail/C24SummaryNewSet/0/RetAmt}",align: ""}
		 		 	  ]}
					 ,{row1: [{type:"Label",value:"Number of Months/Monthly",align: ""}
		 		 			 ,{type:"Text",value:"{/tranDetail/C21SummaryOldSet/0/RetMos}",align: ""}
							  ,{type:"",value:"",align: ""}
		  					  ,{type:"Text",value:"{/tranDetail/C24SummaryNewSet/0/RetMos}",align: ""}
		 		 	  ]}
					 ,{row1: [{type:"Label",value:"Retention Period",align: ""}
		 		 			 ,{type:"Text",value:"{/tranDetail/C21SummaryOldSet/0/RetPeriod}",align: ""}
							  ,{type:"",value:"",align: ""}
		  					  ,{type:"Text",value:"{/tranDetail/C24SummaryNewSet/0/RetPeriod}",align: ""}
		 		 	  ]}
					 ,{row1: []}
					 ,{row1: [{type:"Label",value:"Total TTFE",align: ""}
		 		 			 ,{type:"Text",value:"{/tranDetail/C21SummaryOldSet/0/TtfeAmt}",align: ""}
							  ,{type:"",value:"",align: ""}
		  					  ,{type:"Text",value:"{/tranDetail/C24SummaryNewSet/0/TtfeAmt}",align: ""}
		 		 	  ]}
					 ,{row1: [{type:"Label",value:"TTFE Period",align: ""}
		 		 			 ,{type:"Text",value:"{/tranDetail/C21SummaryOldSet/0/TtfePeriod}",align: ""}
							  ,{type:"",value:"",align: ""}
		  					  ,{type:"Text",value:"{/tranDetail/C24SummaryNewSet/0/TtfePeriod}",align: ""}
		 		 	  ]}
					  ];
		...
		tblProposedPay.bindRows("/tranDetail/C30SpreadSet"); 
		//************************ PROPOSED PAYMENT*******************************************/
		...
		tblContracts.bindRows("/tranDetail/C18RelatedContrSet"); 
		//************************ RELATED CONTRACTS *******************************************/
		...
		var oTBackground = new sap.ui.commons.TextArea({
			...
			value : '{/tranDetail/C33RecommendatiSet}',
			width : "100%",
			rows : 5,
			enabled: false
		});
		...
		var oTRemarks2 = new sap.ui.commons.TextArea({
			tooltip : "Remarks",
			value : '{/tranDetail/C31RemarksSet}',
			width : "100%",
			rows : 5,
			enabled: false
		});
		...
		tblApprovers.bindRows("/tranDetail/C05ApproversSet"); 
		//************************ APPROVAL PATH*******************************************/
		...
		var oBtnApprove = new sap.ui.commons.Button(sessionCache["pageID"] + "oBtnApprove",{
			tooltip : "Approve Restructure",
			width : "100px",
			height : "30px",
			text : "Approve",
			press : function() {
				sap.ui.commons.MessageBox.show(
					      "Are you sure you want to approve request for Restructure?",
		...
		var oBtnDisapprove = new sap.ui.commons.Button(sessionCache["pageID"] + "oBtnDisapprove",{
			tooltip : "Disapprove Restructure",
			width : "100px",
			height : "30px",
			text : "Disapprove",
			press : function() {
				sap.ui.commons.MessageBox.show(
					      "Are you sure you want to disapprove request for Restructure?",
					      sap.ui.commons.MessageBox.Icon.INFORMATION,
					      "Disapprove Request",
					      [sap.ui.commons.MessageBox.Action.YES, sap.ui.commons.MessageBox.Action.NO],
					      function(bResult) { 
