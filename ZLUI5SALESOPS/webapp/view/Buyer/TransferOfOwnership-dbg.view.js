sap.ui.jsview("views.Buyer.TransferOfOwnership", {

	/** Specifies the Controller belonging to this View. 
	* In the case that it is not implemented, or that "null" is returned, this View does not have a Controller.
	* @memberOf views.Buyer.TransferOfOwnership
	*/ 
	getControllerName : function() {
		return "views.Buyer.TransferOfOwnership";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		var oFields = [{ label1: "Company Code",field1: "{/tranDetail/CompanycodeText}",label2: "Contract Number",field2: "{/tranDetail/Contractnumber}"}
		    		 ,{ label1: "Building",field1: "{/tranDetail/BuildingText}",label2: "Date of Sale",field2: "{/tranDetail/SaleDate}",fld2align: ""}
		    		 ,{ label1: "Unit",field1: "{/tranDetail/UnitText}",label2: "TCP Amount",field2: "{/tranDetail/TcpAmount}",fld2align: "End"}
		    		 ,{ label1: "Unit Type",field1: "{/tranDetail/UnittypeText}",label2: "",field2: "",fld2align: ""}];
		...
		tblBuyers.addColumn(new sap.ui.table.Column({
        	label: new sap.ui.commons.Label({text: "Spouse Of"}),
		...
		tblBuyers.bindRows("/tranDetail/transownBuyerFrom"); 
		//************************ BUYERS DETAILS*******************************************/

		//***************************** NEW BUYERS DETAILS ******************************************/
		var tblBuyers2 = new sap.ui.table.Table({
            selectionMode : sap.ui.table.SelectionMode.Single,
        	selectionBehavior : sap.ui.table.SelectionBehavior.RowOnly,
        	editable: false,
        	height : "300px",
		...
		tblBuyers2.addColumn(new sap.ui.table.Column({
        	label: new sap.ui.commons.Label({text: "BP Number"}),
        	template: new sap.ui.commons.TextView().bindProperty("text", "Businesspartner"),
        	editable: false,
        	width: "20%"
		...
		tblBuyers2.setModel(this.getModel());
		tblBuyers2.bindRows("/tranDetail/transownBuyerTo"); 
		//************************ NEW BUYERS INFO*******************************************/
		...
		tblApprovers.bindRows("/tranDetail/transownToapprover"); 
		//************************ APPROVAL PATH*******************************************/
		...
		oBuyersLayout.createRow(tblBuyers, null,tblBuyers2 );
		
        var oSection4 = new sap.ui.commons.AccordionSection();     
        oSection4.setTitle("Buyers Detail");		
        oSection4.setTooltip("Buyers Detail");
        oSection4.addContent( oBuyersLayout);
		...
		var oBtnApprove = new sap.ui.commons.Button(sessionCache["pageID"] + "oBtnApprove",{
			tooltip : "Approve Transfer of Ownership",
			width : "100px",
			height : "30px",
			text : "Approve",
			press : function() {
				sap.ui.commons.MessageBox.show(
					      "Are you sure you want to approve request for Transfer of Ownership?",
